...
#'
#' @description This \code{TrajectoryDataSet} class holds the inferred clonotype lineages from \code{getClonotypeLineages}.
...
#' @slot trajectoryParams. Additional parameters used by \code{getClonotypeLineages}. These may specify how the minimum spanning tree on clusters was constructed:
#'  \itemize{
