...
occupiedscRepertoire <- function(Combined,group.by=NULL, cloneTypes=c(Small = 0.001, 
    ...
    PreMeta <- unique(Con.df[,c("barcode", "cdr3", "Frequency", "cloneType")])
